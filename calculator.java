...
class calculator extends JFrame implements ActionListener {
	...
	public static void main(String args[])
	{
		...
		beq1.setPreferredSize(new Dimension(60, 40));
		ba.setPreferredSize(new Dimension(60, 40));
		bs.setPreferredSize(new Dimension(60, 40));
		bd.setPreferredSize(new Dimension(60, 40));
		bm.setPreferredSize(new Dimension(60, 40));
		beq.setPreferredSize(new Dimension(60, 40));
		be.setPreferredSize(new Dimension(60, 40));
